...
export const getPayrollRuns    = (params) => api.get(P.RUN, { params }).then(r => r.data);
export const getPayrollSummary = (params) => api.get(P.SUMMARY, { params }).then(r => r.data);
...
// Employee
export const getMyPayslips = (params) => api.get(P.MY, { params }).then(r => r.data);
